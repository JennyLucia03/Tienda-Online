                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <div>
                                    <a href="srvUsuario?accion=AgregarCarrito&id=${p.getId()}" class="btn btn-outline-info">Agregar a carrito</a>
                                    <a href="srvUsuario?accion=Comprar&id=${p.getId()}" class="btn btn-outline-danger">Comprar</a>
                                </div>
                            </div>
                        </div>
                    </div>
